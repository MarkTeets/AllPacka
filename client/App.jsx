...
// to grab user objects. Said user objects are then stored via useContext. Trips also have unique
// fetch paths and are then stored via useContext. Loaders only make sense when a 
